// components/AdminTicketDetail.tsx
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                >
                  <div
                    className={`max-w-xs md:max-w-md p-4 rounded-2xl ${
                      message.sender.role === "user"
                        ? "bg-blue-50 rounded-tl-none text-left"
        ...
        <div className="space-y-6">
          ...
          {/* User Info */}
          <Card>
            <h3 className="text-lg font-bold mb-4">اطلاعات کاربر</h3>
          ...
          {/* Admin Assignment */}
          <Card>
            <h3 className="text-lg font-bold mb-4">اختصاص ادمین</h3>
            {ticket.admin ? (
              <div className="space-y-2">
